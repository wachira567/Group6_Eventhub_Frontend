        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="bg-white rounded-xl shadow-sm">
              {/* Header */}
              <div className="p-6 border-b border-[#E6E5E8]">
                <h1 className="text-2xl font-bold text-[#1E0A3C] mb-4">My Tickets</h1>
                          ...
                          <div className="flex-1 p-6">
                            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                              ...
                              <div className="text-right">
                                <p className="text-sm text-[#6F7287]">Ticket #{ticket.ticket_number}</p>
                            ...
                            <div className="mt-4 pt-4 border-t border-[#E6E5E8] flex flex-wrap items-center justify-between gap-4">
                              <div className="flex gap-4 text-sm">
                                <span className="text-[#6F7287]">
                                  <span className="font-medium text-[#39364F]">{ticket.quantity}</span> x {ticket.ticket_type_name || 'Ticket'}
                                </span>
                              </div>
